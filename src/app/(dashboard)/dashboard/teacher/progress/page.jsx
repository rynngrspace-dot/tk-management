...
const PAUD_LABEL = { 1: "BB", 2: "MB", 3: "BSH", 4: "BSB" };
const PAUD_COLOR = {
                                  ...
                                  <div className="space-y-1.5">
                                    ...
                                    <div className="grid grid-cols-2 gap-x-4 gap-y-1">
                                      {Object.entries(weekData.scores).map(([code, score]) => {
                                        const label = PAUD_LABEL[score] || score;
                                        const colorClass = PAUD_COLOR[score] || "text-slate-400 bg-transparent";
                                        return (
                                          <div key={code} className="flex justify-between items-center gap-3">
                                            ...
                                            <span className={`text-[10px] font-black px-1.5 py-0.5 rounded ${colorClass}`}>{label}</span>
                                          </div>
                                        );
                                      })}
                                    </div>
