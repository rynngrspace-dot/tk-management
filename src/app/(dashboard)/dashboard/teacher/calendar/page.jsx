    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-white/60 p-4">
          ...
          <div className="space-y-2">
            <Link href="/dashboard/teacher/attendance" className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm font-medium text-slate-600 hover:bg-emerald-50 hover:text-emerald-700 transition-colors">
              <ClipboardCheck className="w-4 h-4" /> Input Absensi Hari Ini
            </Link>
            <Link href="/dashboard/teacher/assessment" className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm font-medium text-slate-600 hover:bg-indigo-50 hover:text-indigo-700 transition-colors">
              <ListChecks className="w-4 h-4" /> Input Nilai Minggu Ini
            </Link>
            <Link href="/dashboard/teacher/progress" className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm font-medium text-slate-600 hover:bg-violet-50 hover:text-violet-700 transition-colors">
